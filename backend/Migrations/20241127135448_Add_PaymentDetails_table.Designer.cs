...
namespace backend.Migrations
{
    ...
    [Migration("20241127135448_Add_PaymentDetails_table")]
    partial class Add_PaymentDetails_table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.Order", b =>
                {
                    ...
                    b.HasOne("backend.Models.PaymentDetail", "PaymentDetail")
                        .WithOne("Order")
                        .HasForeignKey("backend.Models.Order", "PaymentDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
